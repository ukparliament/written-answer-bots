xml.rss( :version => '2.0', 'xmlns:atom' => 'http://www.w3.org/2005/Atom' ) do
  xml.channel do
    ...
    xml.link( answering_body_answer_list_url( :answering_body => @answering_body.mnis_id ) )
    ...
    xml.tag!( 'atom:link', { :href => answering_body_answer_list_url( :answering_body => @answering_body.mnis_id, :format => 'rss' ), :rel => 'self', :type => 'application/rss+xml' } )
