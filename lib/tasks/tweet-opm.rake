...
task :tweet_opm => :environment do
  ...
  # We find the OPM by its MNIS ID.
  answering_body = AnsweringBody.find_by_mnis_id( 23 )
  
  # We get all the answered questions from OPM that have not yet been tweeted.
